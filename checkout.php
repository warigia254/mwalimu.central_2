		...
		<div class="card-body">
			...
			<table class="table">
				...
				<tr>
					...
					<td><?php echo "KShs" . $book['book_price']; ?></td>
					<td><?php echo $qty; ?></td>
					<td><?php echo "KShs" . $qty * $book['book_price']; ?></td>
				</tr>
				<?php } ?>
				<tr>
					<th>&nbsp;</th>
					...
					<th><?php echo "KShs" . $_SESSION['total_price']; ?></th>
				</tr>
			</table>
			</div>
		</div>
		...
		<div class="col-lg-5 col-md-8 col-sm-10 col-xs-12">
			<div class="card rounded-0 shadow">
				...
				<div class="card-body container-fluid">
					...
					<p class="fw-light fst-italic"><small class="text-muted">Please click Purchase to confirm your purchase, or Continue Shopping to add or remove items.</small></p>
				</div>
			</div>
		</div>
	</div>
